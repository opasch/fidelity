defmodule FidelityAppWeb.UserAuthTest do
  use FidelityAppWeb.ConnCase, async: true

  alias FidelityApp.Accounts
  alias FidelityAppWeb.UserAuth
  import FidelityApp.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FidelityAppWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FidelityAppWeb.Endpoint.subscribe(live_socket_id)
