defmodule FidelityAppWeb.Plugs.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug FidelityAppWeb.Plugs.EnsureRolePlug, [:user, :admin]

      plug FidelityAppWeb.Plugs.EnsureRolePlug, :admin

      plug FidelityAppWeb.Plugs.EnsureRolePlug, ~w(user admin)a
  """
