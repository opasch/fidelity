defmodule FidelityApp.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, FidelityApp.Repo)
  ...
  def changeset_role(user_or_changeset, attrs) do
    ...
    |> Ecto.Changeset.validate_inclusion(:role, ~w(customer merchant admin))
  end
  ...
  """
  def valid_password?(%FidelityApp.Accounts.User{hashed_password: hashed_password}, password)
